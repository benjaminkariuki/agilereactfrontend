...
const DetailsImplementationDialog = ({showDetailsIm, disableShowDelegateDialogImp }) => {
  ...
  useEffect(() => {
    ...
    const config = {
      ...
      axios
        .get(
          `https://agile-pm.agilebiz.co.ke/api/allProjectImplementationTitles?page=${page + 1}`,config
        )
        .then((response) => {
  ...
  return (
    <div>
      {/* <Toast ref={toast} /> */}
      <Dialog
        header={"Projects: Implementation"}
        visible={showDetailsIm}
        onHide={disableShowDelegateDialogImp}
...
export default DetailsImplementationDialog;
