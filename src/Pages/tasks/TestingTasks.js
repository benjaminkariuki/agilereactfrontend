...
const TestingTasks = () => {
  ...
  const fetchMyTasks = (userEmail, userRole, userDepartment) => {
    ...
    axios
      .get(`${API_BASE_URL}/myTasksTesting`, {
        params: {
          email: userEmail,
          roleName: userRole,
  ...
  const fetchOtherTasks = (userEmail, userRole, userDepartment) => {
    ...
    axios
      .get(`${API_BASE_URL}/OtherTasksTesting`, {
        params: {
          email: userEmail,
          roleName: userRole,
          department: userDepartment,
  ...
  const fetchReturnedTaskLogs = () => {
    ...
    axios
      .get(`${API_BASE_URL}/fromreviewtotesting`, {
        params: {
          email: userEmail,
  ...
  const submitPushBack = (event) => {
    ...
    axios
      .post(
        `${API_BASE_URL}/returnToDevelopment`,
        formData,
        {
          headers: {
            ...config.headers,
